...
def create_model(qs, d):
    ...
    #layer1 = tfq.layers.NoisyPQC(model_circuit(qs, d), readout_operators, repetitions=1000, sample_based=True, differentiator=tfq.differentiators.ParameterShift())(inputs)
